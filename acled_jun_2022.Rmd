...
conflict_score %>%
  mutate(beneficiaries = log(beneficiaries)) %>% 
  ...
  labs(x = "Log of beneficiaries",
       y = "Conflict score",
title = "Relationship between Q1 2022 beneficiaries reached and conflict score at township level",
...
[![conflict network graph](./text_mining/conflict_network_graph_june22.png)](https://raw.githubusercontent.com/food-security-cluster-myanmar/exploratory-data-analysis-acled-fsc/master/text_mining/conflict_network_graph_june22.png){target="_blank"}
Click **[here](https://raw.githubusercontent.com/food-security-cluster-myanmar/exploratory-data-analysis-acled-fsc/master/text_mining/conflict_network_graph_june22.png){target="_blank"}** to see the full-sized graph. 
