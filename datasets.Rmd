...
From 2021 version of the 5Ws. Administrative level 3 place codes. Public. Link
...
MIMU shapefiles. Administrative levels 1 and 3 shapefiles. Public. Link
...
Extracted 2022-01-25. Conflict reference table, at incident level. Provided by MIMU. Read into .csv for public sharing. [Link](); only used for this report.  
...
Only observations from 2021 used in the report. Public. Report link (outdated); updated Link. 
...
Textmining dataset. Created using `tidytext`. Contains all words from conflict descriptions of each conflict incident, filtered by stopword. Public. 
...
Census reference dataset. Dataset used for the creation of the MIMU-HARP Vulnerability Index bassed on 2015 Census data. Public. 
