---
title: "**Understanding Conflict Dynamics in Myanmar through Conflict and Incident Data: A Food Security Perspctive**"
...
The map below shows the six most common conflict interaction types. Of these, four involve the Military.
...
acled %>%  
  ...
  kable_styling(latex_options = c("HOLD_position"), full_width = FALSE, position = "center", font_size = 8)
```
...
kable(top_actors, caption = "Top conflict actors in 2021 by actor type", format.args = list(big.mark = ","), booktabs = TRUE) %>% 
