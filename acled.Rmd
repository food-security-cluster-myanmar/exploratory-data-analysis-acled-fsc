...
### 3.4 Conflict fatalities in 2021
...
The largest number of fatalities are related to events involving the military, political militias, including the People’s Defense Force, and rebel groups. 
...
### 5.3 Actors associated with the mmost fatalities
...
vulmmr %>% 
  ...
  mutate(`Harvested area %` = round(harvested_area / sum(harvested_area) * 100, digits = 2),
...
As a point of comparison, ACLED’s methodology and dataset was discussed with the Nexus Response Mechanism’s (NRM) Conflict Analysis and Research Facility. It was noted that the two datasets are very similar, both relying largely on media sources, with the only exception being the inclusion of social media posts in the NRM dataset. The FSC will continue to use ACLED data for analysis going forward as it is free and publicly available. 
