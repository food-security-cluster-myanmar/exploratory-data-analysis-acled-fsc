...
actors %>%
  ...
  summarise(count = n(),
            fatalities = sum(fatalities)) %>% 
  group_by(event_type) %>% 
  filter(inter1 %out% c("external_other_force", "identity_militias")) %>% 
...
actors %>% 
  ...
  kable(caption = "Top actors in terms of fatalities associated with them; actors associated with less than 100 fatalities have been lumped together as 'Other'",
