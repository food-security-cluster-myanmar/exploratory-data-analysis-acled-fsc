...
```
 ...
 Many of the literal choke points in this conflict have to do with major roads. The map below shows conflict events as points in red and major roads in blue. The yellow square is Nay Pyi Taw and the light blue squares are Tamu in Sagaing and Muse and Tachileik in Shan. 
 
 ![](./misc/road_conflict.png)
