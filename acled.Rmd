...
acled %>%  
 ...
 #  mutate(month = fct_rev(month)) %>% 
  ...
  labs(x = "",
       y = "Number of events", 
       title = "Number of 2021 conflict events, by type",
...
The table below shows the correlations between individual words within the column `notes` of the ACLED dataset which contains the descriptions of each conflict event. Only words which appeared more than 50 times in 2021 were included. To reduce the size of the table loaded, only the top 20 matches per word were included. A correlation of 1 means that the word always appears with its match in the dataset, a correlation of 0.5 means that the word shows appears in the same event as its match 50% of the time. 
