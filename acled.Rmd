...
#TOC::before {
  ...
  background-image: url("./misc/Myanmar_cluster_blue.png");
...
[![conflict network graph](./text_mining/conflict_network_graph.png)](https://raw.githubusercontent.com/food-security-cluster-myanmar/exploratory-data-analysis-acled-fsc/master/conflict_network_graph.png){target="_blank"}
